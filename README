...
Hace un poco más de un año descubrí una vulnerabilidad sobre unos modelos de routers de la empresa Movistar, la vulnerabilidad se reportó ante colCERT (Grupo de Respuesta a Emergencias Cibernéticas de Colombia), pero su tramite duró mas de año y medio y no se realizó una solución efectiva. Durante este tiempo una empresa de seguridad rusa descubrió un ataque sistemático sobre estos dispositivos, en su estudio se descubrieron más de 300.000 dispositivos vulnerados, de estos 50.000 pertenecientes a Colombia.
